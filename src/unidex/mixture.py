"""
Individual mixture in PaliGemma format, migrated for PiZero
"""
from typing import Optional, Tuple
import torch
import torch.nn as nn
from src.unidex.lora import get_layer
from src.unidex.paligemma_modules import (
    GemmaMLP,
    GemmaRMSNorm,
    GemmaRotaryEmbedding,
)
from src.utils import apply_rotary_pos_emb, repeat_kv
from src.unidex.modules import AdaptiveLayerscale, AdaptiveRMSNorm
